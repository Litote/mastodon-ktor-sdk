...
import org.litote.mastodon.ktor.sdk.sharedAccountsapiv1accountsidstatusesget2b22751c.model.PreviewCardAuthor
import org.litote.mastodon.ktor.sdk.sharedAccountsapiv1accountsidstatusesget2b22751c.model.TrendsLinkTypeEnum
...
public data class TrendsLink(
  ...
  public val type: TrendsLinkTypeEnum = TrendsLinkTypeEnum.UNKNOWN_,
